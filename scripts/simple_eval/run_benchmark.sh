...
python simple_eval/judge_eval.py --model gpt-4o --task summary
python simple_eval/judge_eval.py --model gpt-4o-mini --task summary
python simple_eval/judge_eval.py --model gpt-4o --task hh_rlhf_helpful
python simple_eval/judge_eval.py --model gpt-4o-mini --task hh_rlhf_helpful